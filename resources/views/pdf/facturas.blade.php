...
<body>
    ...
    $logoSrc = $userLog->logo_base64 ?? $userLog->logo ?? '';
    @endphp
    <div class="header">
        ...
        <table class="border full-width">
            <tfoot>
                ...
                <tr>
                    ...
                    <td style="font-size:13px; border-left: none; white-space: nowrap;" class="right-align">{{ $recibo['sub_total'] }}€</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="font-size:13px;border-left: none; white-space: nowrap;" class="right-align">{{ $recibo['total_descuento'] > 0 ? $recibo['total_descuento'] : 0 }}€</td>
                </tr>
                @endif
                ...
                <tr>
                    ...
                    <td style="font-size:13px;border-left: none; white-space: nowrap;" class="right-align">
                        {{ $recibo['iva'] }}€
                    </td>
                </tr>
                @endif
                ...
                <tr>
                    ...
                    <td style="font-size:13px; !important;border-left: none; white-space: nowrap;" class="right-align">{{ $recibo['sub_total'] }}€</td>
                </tr>
                <tr>
                    <td style="font-size:13px;border-right:none" class="right-align" colspan="3"><strong>DESCUENTO</strong></td>
                    <td style="font-size:13px;border-left: none; white-space: nowrap;" class="right-align">{{ $recibo['total_descuento'] > 0 ? $recibo['total_descuento'] : 0 }}€</td>
                ...
                <tr>
                    <td style="font-size:13px;border-right:none" class="right-align" colspan="3"><strong>TOTAL</strong></td>
                    <td style="font-size:13px;border-left: none; white-space: nowrap;" class="right-align"> {{ $recibo['sub_total'] - $recibo['total_descuento'] }}€</td>
                </tr>
                @else
                <tr>
                    <td style="font-size:13px;border-right:none" class="right-align" colspan="3"><strong>TOTAL</strong></td>
    ...
    @if(!empty($signature))
    <div class="full-width" style="text-align: right; margin-top: 1.5rem;">
