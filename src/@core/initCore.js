...
const _syncAppRtl = () => {
  ...
  // Forzar español por defecto si no hay cookie o si está en inglés
  const defaultLocale = themeConfig.app.i18n.defaultLocale || 'es'
  if (!storedLang.value || storedLang.value === 'en') {
    storedLang.value = defaultLocale
