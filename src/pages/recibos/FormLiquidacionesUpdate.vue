<template>
    <VCard title="Editar liquidación">
        <VDivider></VDivider>
                ...
                <VRow dense>
                    ...
                    <VCol
                        ...
                        <VTextField
                            ...
                            hint="Solo el número. Se almacena como CO-n (serie compartida con autofacturas)."
        ...
        <VDialog
            ...
            <VCard>
                <VCardTitle
                    ...
                    >Duplicar liquidación</VCardTitle
                >
                <VCardText class="text-center pt-6">
                    <h5 class="text-h5">
                        ¿Está seguro de que desea crear una nueva liquidación con
...
export default {
    ...
    methods: {
        ...
        recalcTotalesSiHayLineas() {
            if (
                this.facturaRec.items &&
                this.facturaRec.items.length > 0
            ) {
        ...
        callDown(doc) {
            ...
            let pathServer = "/storage/recibos/userId_" + ownerId + "/liquidaciones/";
            let pathDoc = "";
            let documentImagen = "";
        ...
        facturaRecById(id) {
            axios.get(`api/liquidaciones-show/` + id).then(
                (res) => {
        ...
        saveFactRecibidas() {
            ...
            const lineaInvalida = this.facturaRec.items.some((l) => {
            ...
            axios
                .post(
                    `api/liquidaciones-update/` + this.facturaRec.id,
                    formData
                )
                .then(
                    (res) => {
        ...
        duplicarLiquidacion() {
            ...
            axios
                .post(`api/duplicar-liquidacion`, formData)
                .then(
                    (res) => {
                        // const response = res.data.success
                        $toast.sucs("Liquidación duplicada con exito");
                        this.$router.push("/lista-liquidaciones");
