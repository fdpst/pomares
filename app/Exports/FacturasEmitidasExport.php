...
class FacturasEmitidasExport implements 
    ...
    public function collection()
    {
        ...
        foreach($this->data['recibos'] as $recibo){
            $data->push([
                ...
                $recibo?->cliente?->cuentaContable?->numero??'000000000',
                $recibo->cliente?->nombre,
                $recibo->cliente?->dni,
                'A/'.$recibo->nro,
                'ORD',
                number_format( $recibo->sub_total,2,','.''),
                number_format( $recibo->tipo_iva,2,','.''),
                number_format( $recibo->iva,2,','.''),
                '',
                '',
                '',
